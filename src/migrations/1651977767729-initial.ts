...
export class initial1651977767729 implements MigrationInterface {
    name = 'initial1651977767729'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("DROP INDEX `customers_FK` ON `customers`");
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` bigint NOT NULL AUTO_INCREMENT, `first_name` char(40) NULL, `last_name` char(40) NULL, `email` char(40) NULL, `password` char(80) NOT NULL, `created_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp(6) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE INDEX `customers_FK` ON `customers` (`agent_code`)");
    }
